...
{!! subMenuRenderer(__('Admin and Role'),$menu ?? '', 'role','user1.svg',[
    ...
    ['route' => 'admin.login.activity', 'title' => __('Login Activity'),'tab' => $sub_menu ?? '', 'tab_compare' => 'admin_login_activity', 'route_param' => NULL ],
]) !!}

{!! subMenuRenderer(__('Banks'),$menu ?? '', 'bank_form','bank.svg',[
    ['route' => 'bank.form.list.page', 'title' => __('Bank Form'),'tab' => $sub_menu ?? '', 'tab_compare' => 'bank_form', 'route_param' => NULL ],
    ['route' => 'bank.form.record.list.page', 'title' => __('Admin Bank'),'tab' => $sub_menu ?? '', 'tab_compare' => 'admin_bank', 'route_param' => NULL ],
]) !!}
