...
class PermissionFromDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            // Supported Network
            ['group' => 'supported_network','action' => 'View','for' => 'Supported Network List','route' => 'supportedNetworkList'],
            ['group' => 'supported_network','action' => 'View','for' => 'Add Page Of Supported Network','route' => 'creteSupportedNetworkPage'],
            ['group' => 'supported_network','action' => 'View','for' => 'Edit Page Of Supported Network','route' => 'supportedNetworkEdit'],
            ['group' => 'supported_network','action' => 'Add','for' => 'Add Supported Network','route' => 'creteSupportedNetwork'],
            ['group' => 'supported_network','action' => 'Edit','for' => 'Edit Supported Network','route' => 'supportedNetworkEditProccess'],
            ['group' => 'supported_network','action' => 'Status','for' => 'Update Status Of Supported Network','route' => 'supportedNetworkStatus'],

            // System Wallet
            ['group' => 'system_wallet','action' => 'View','for' => 'Admin System Wallet List','route' => 'getSystemWalletList'],
            ['group' => 'system_wallet','action' => 'View','for' => 'Add/Edit Page Of Admin System Wallet','route' => 'createSystemWallet'],
            ['group' => 'system_wallet','action' => 'View','for' => 'View Password Of Admin System Wallet','route' => 'viewSystemWalletey'],
            ['group' => 'system_wallet','action' => 'Add/Edit','for'  => 'Add/Edit Admin System Wallet','route' => 'createSystemWalletProccess'],
            ['group' => 'system_wallet','action' => 'Edit','for' => 'Edit Admin System Wallet','route' => 'updateSystemWalletey'],
            ['group' => 'system_wallet','action' => 'Status','for' => 'Update Status Of Admin System Wallet','route' => 'changeSystemWalletStatus'],

            // Coin Network
            ['group' => 'coin_network','action' => 'View','for' => 'Coin Network List','route' => 'getCoinNetworkList'],
            ['group' => 'coin_network','action' => 'View','for' => 'Add/Edit Page Of Coin Network','route' => 'createCoinNetwork'],
            ['group' => 'coin_network','action' => 'View','for' => 'View Setting Page Of Coin Network','route' => 'adminCoinSettings'],
            ['group' => 'coin_network','action' => 'Add','for' => 'Add Coin Network','route' => 'createCoinNetworkProcess'],
            ['group' => 'coin_network','action' => 'Edit','for' => 'Edit Coin Network','route' => 'updateCoinNetworkProcess'],
            ['group' => 'coin_network','action' => 'Delete','for' => 'Delete Coin Network','route' => 'coinNetworkDelete'],
            ['group' => 'coin_network','action' => 'Update','for' => 'Update Status Of Coin Network','route' => 'changeCoinNetworkStatus'],

            // Network
            ['group' => 'network','action' => 'View','for' => 'Network List','route' => 'getNetworkList'],
            ['group' => 'network','action' => 'View','for' => 'Add/Edit Page Of Network','route' => 'createNetwork'],
            ['group' => 'network','action' => 'Add/Edit','for' => 'Add Network','route' => 'createNetworkProcess'],
            ['group' => 'network','action' => 'Update','for' => 'Update Status Of Network','route' => 'changeNetworkStatus'],

            // Bank Form
            ['group' => 'bank_form','action' => 'View','for' => 'Admin Bank List','route' => $this->filtertext('bank.form.list.page')],
            ['group' => 'bank_form','action' => 'Add/Edit','for' => 'Admin Bank List','route' => $this->filtertext('bank.form.submit')],
            // ['group' => 'bank_form','action' => 'Update','for' => 'Update Bank Form Status','route' => $this->filtertext('bank.form.status')],
            // ['group' => 'bank_form','action' => 'Delete','for' => 'Delete Bank Form','route' => $this->filtertext('bank.form.delete')],

            // Bank Form Field
            ['group' => 'bank_form_field','action' => 'View','for' => 'Bank Form Field List','route' => $this->filtertext('bank.form.field.list')],
            ['group' => 'bank_form_field','action' => 'Add/Edit','for' => 'Add/Edit Bank Form Field','route' => $this->filtertext('bank.form.field.save')],
            ['group' => 'bank_form_field','action' => 'Update','for' => 'Update Bank Form Field Status','route' => $this->filtertext('bank.form.field.status')],
            ['group' => 'bank_form_field','action' => 'Delete','for' => 'Delete Bank Form Field','route' => $this->filtertext('bank.form.field.delete')],

            // Admin Bank
            ['group' => 'admin_bank','action' => 'View','for' => 'Admin Bank List','route' => $this->filtertext('bank.form.record.list.page')],
            ['group' => 'admin_bank','action' => 'Add/Edit','for' => 'Admin Bank List','route' => $this->filtertext('bank.form.record.save')],
            ['group' => 'admin_bank','action' => 'Update','for' => 'Update Bank Record Status','route' => $this->filtertext('bank.form.record.status')],
            ['group' => 'admin_bank','action' => 'Delete','for' => 'Delete Bank Record','route' => $this->filtertext('bank.form.record.delete')],

            //Wallet Address List
            ['group' => 'wallet_list','action' => 'View','for' => 'View Users Wallet Address List','route' => $this->filtertext('walletAddressList')],

            //All Transaction
            ['group' => 'transaction_all','action' => 'View','for' => 'All Currency Transaction History','route' => "adminTransactionHistoryCurrency"],
            // ['group' => 'transaction_all','action' => 'View','for' => 'Currency Withdrawal History','route' => "adminWithdrawalHistoryCurrency"],

            //Transaction deposit
            ['group' => 'transaction_deposit','action' => 'View','for' => 'Currency Pending History','route' => "adminPendingCurrencyDeposit"],
            ['group' => 'transaction_deposit','action' => 'Accept','for' => 'Currency Accept Deposit','route' => "adminPendingCurrencyDepositAcceptProcess"],
            ['group' => 'transaction_deposit','action' => 'Reject','for' => 'Currency Reject Deposit','route' => "adminPendingCurrencyDepositRejectProcess"],
            ['group' => 'transaction_deposit','action' => 'Reject','for' => 'Currency Reject Deposit','route' => "adminPendingCurrencyDepositRejectProcess"],

            //Withdrawal Transaction
            ['group' => 'transaction_withdrawal','action' => 'View','for' => 'Currency Withdrawal Transaction History','route' => "adminPendingWithdrawalCurrency"],

            //Fiat Currency
            ['group' => 'fiat_withdraw_list','action' => 'View','for' => 'Fiat Withdrawal Payment Method','route' => "getWithdrawlPaymentMethod"],

            //Coin Pair
            ['group' => 'coin_pair','action' => 'View','for' => 'Trade Fees Setting Of Coin Pair','route' => "tradeFeesSettings"],

             //Fiat Currency
             ['group' => 'currency_list','action' => 'View','for' => 'Currency List Setting','route' => "adminCurrencyList"],
        ];
