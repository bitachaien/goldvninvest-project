...
function bankShowHtml($bank, $bank_name = "Bank")
{
    if (!$bank)
    ...
    $details = "";
    foreach ($bank as $slug => $bank) {
        $details .= '<li><b>' . ($bank["title"] ?? "") . ':</b> ' . ($bank["value"] ?? "") . '</li>';
    }

    $html = '<li style="list-style: none;" class="userbank"><a title="' . __('Image') . '" href="#show_bank_html_' . $uniq . '" data-toggle="modal"><span class="">' . $bank_name . '
    </span></a> </li>';
    $html .= '<div id="show_bank_html_' . $uniq . '" class="modal fade delete" role="dialog">';
    $html .= '<div class="modal-dialog modal-lg">';
    $html .= '<div class="modal-content">';
    $html .= '<div class="modal-header"><h6 class="modal-title">' . __('User Bank Details'). ": $bank_name " . '</h6><button type="button" class="close" data-dismiss="modal">&times;</button></div>';
    $html .= '<div class="modal-body">';
    $html .= '<div> <p> <ul>'.  $details .'</ul> </p> </div>';
    $html .= '<div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">' . __("Close") . '</button>';
    $html .= '</div>';
    $html .= '</div>';
    $html .= '</div>';
...
function bankDepositShowHtml($item, $bank, $recipt, $bank_name = "Bank")
{
    if (!$bank)
        return __('Bank not found');
    ...
    $html .= '<div id="show_bank_html_' . $uniq . '" class="modal fade delete text-left" role="dialog">';
    $html .= '<div class="modal-dialog modal-lg">';
    $html .= '<div class="modal-content">';
    $html .= '<div class="modal-header"><h6 class="modal-title">' . __('User Bank Details') .": $bank_name ". '</h6><button type="button" class="close" data-dismiss="modal">&times;</button></div>';
    $html .= '<div class="modal-body">';
...
function modal_image_show($id, $image_name, $bank_name = "Bank")
{
    $html = '<a title="' . __('Receipt') . '" class="delete" href="#image_id_' . $id . '" data-toggle="modal">' . $bank_name . '</a>';
    $html .= '<div id="image_id_' . $id . '" class="modal fade delete" role="dialog">';
    $html .= '<div class="modal-dialog modal-md">';
    $html .= '<div class="modal-content">';
    $html .= '<div class="modal-header"><h6 class="modal-title">' . __('Bank Receipt'). ": $bank_name" . '</h6><button type="button" class="close" data-dismiss="modal">&times;</button></div>';
    $html .= '<div class="modal-body">
...
function make_unique_slug($title, $table_name = NULL, $column_name = 'slug')
{
    ...
    $slug = trim($slug, "-");
    if (isset($table_name)) {
        $item = DB::table($table_name)->where($column_name, $slug)->exists();
        if (isset($item)) {
