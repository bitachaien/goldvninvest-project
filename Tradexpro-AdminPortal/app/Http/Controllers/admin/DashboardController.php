...
class DashboardController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        $w_fees = $this->dashboardService->getWithdrawalTotalEarning();
        $data['total_earning'] = $buy_fees + $sell_fees + $w_fees;
        $data['total_user'] = User::where('role', USER_ROLE_USER)->whereNotIn('status', [STATUS_DELETED, STATUS_FORCE_DELETED])->count();
