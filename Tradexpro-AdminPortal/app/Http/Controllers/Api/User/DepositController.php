...
class DepositController extends Controller
{
    ...
    public function currencyDepositInfo(Request $request, IBankService $bankService): JsonResponse
    {
        $data['banks'] = $bankService->adminBankList()['data'] ?? null;
    ...
    public function getCurrencyDepositPageData(Request $request, IBankService $bankService)
    {
        $data['banks'] = $bankService->adminBankList()['data'] ?? null;
