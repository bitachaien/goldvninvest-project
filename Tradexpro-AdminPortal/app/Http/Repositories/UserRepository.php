...
class UserRepository
{
    ...
    {
        return $this->model->select('id', 'email')->get();
    }

    public function userActivities(int $userID = 0, int $limit = 10): LengthAwarePaginator
    {
        $data = ActivityLog::where('user_id', $userID)
            ->where('action',USER_ACTIVITY_LOGIN)
